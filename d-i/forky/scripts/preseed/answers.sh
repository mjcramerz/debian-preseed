...
render_answers_file() {
  ...
  if installer_selected_class_reference_is_selected addon/server-suite 2>/dev/null; then
    planned_mirror_suite=trixie
    planned_local_repos='sid,forky,xanmod,cramerz'
  fi
