...
podman_stage_podbin_assets() {
  ...
  stage_target_asset "$(installer_repo_join_var DIR_HOOKS_SHARED_TARGET data/config/podman/templates/podbin/images/runtime/entrypoint.sh.tmpl)" "${PODBIN_TEMPLATE_DIR}/images/runtime/entrypoint.sh" 0644
  ...
  stage_target_asset "$(installer_repo_join_var DIR_HOOKS_SHARED_TARGET data/config/podman/templates/podbin/user.env.tmpl)" "${PODBIN_TEMPLATE_DIR}/user.env.tmpl" 0644
  install -d -m 0755 \
