...
shared_hook_path=$(installer_repo_join_var DIR_HOOKS_SHARED late_command.sh)
...
shared_modules="core target-assets volatile-storage storage-maintenance mullvad templates network grub security dbus-broker podman gitlab-runner zram-swap btrfs-family f2fs-family account"
