...
late_command_fetch_common_assets() {
  ...
  fetch_hook "$(installer_repo_join_var DIR_HOOKS_SHARED_TARGET usr/local/libexec/apt-refresh-lists.tmpl)" "$TMP_ENV_DIR/apt-refresh-lists.tmpl"
  ...
  fetch_hook "$(installer_repo_join_var DIR_HOOKS_SHARED_TARGET usr/local/libexec/tmpfs-pre-clean.tmpl)" "$TMP_ENV_DIR/tmpfs-pre-clean.tmpl"
...
install_target_runtime_defaults() {
  ...
  validate_installed_log_levels
  render_target_asset "$(installer_repo_join_var DIR_HOOKS_SHARED_TARGET etc/default/system-runtime.tmpl)" /etc/default/system-runtime 0644
  stage_target_asset \
    "$(installer_repo_join_var DIR_HOOKS_SHARED_TARGET etc/systemd/logind.conf.d/override.conf)" \
...
install_target_wpa_supplicant_runtime_policy() {
  ...
  stage_target_asset \
    ...
    0644
  stage_target_asset \
    "$(installer_repo_join_var DIR_HOOKS_SHARED_TARGET etc/systemd/system/wpa_supplicant.service.d/override.conf)" \
    "${FILE_WPA_SUPPLICANT_DBUS_SERVICE_OVERRIDE}" \
    0644
  stage_target_asset \
    "$(installer_repo_join_var DIR_HOOKS_SHARED_TARGET etc/NetworkManager/conf.d/80-managed-link-privacy.conf)" \
...
install_target_firstboot_logger() {
  ...
  stage_target_asset "$(installer_repo_join_var DIR_HOOKS_SHARED_TARGET etc/initramfs-tools/scripts/installer-health-common)" "${FILE_INITRAMFS_HEALTH_COMMON}" 0644
  stage_target_asset "$(installer_repo_join_var DIR_HOOKS_SHARED_TARGET etc/initramfs-tools/scripts/init-top/90-installer-health)" "${FILE_INITRAMFS_HEALTH_INIT_TOP}" 0755
  stage_target_asset "$(installer_repo_join_var DIR_HOOKS_SHARED_TARGET etc/initramfs-tools/scripts/init-premount/90-installer-health)" "${FILE_INITRAMFS_HEALTH_INIT_PREMOUNT}" 0755
  stage_target_asset "$(installer_repo_join_var DIR_HOOKS_SHARED_TARGET etc/initramfs-tools/scripts/local-top/90-installer-health)" "${FILE_INITRAMFS_HEALTH_LOCAL_TOP}" 0755
  stage_target_asset "$(installer_repo_join_var DIR_HOOKS_SHARED_TARGET etc/initramfs-tools/scripts/local-block/90-installer-health)" "${FILE_INITRAMFS_HEALTH_LOCAL_BLOCK}" 0755
  stage_target_asset "$(installer_repo_join_var DIR_HOOKS_SHARED_TARGET etc/initramfs-tools/scripts/local-premount/90-installer-health)" "${FILE_INITRAMFS_HEALTH_LOCAL_PREMOUNT}" 0755
  stage_target_asset "$(installer_repo_join_var DIR_HOOKS_SHARED_TARGET etc/initramfs-tools/scripts/local-bottom/90-installer-health)" "${FILE_INITRAMFS_HEALTH_LOCAL_BOTTOM}" 0755
  stage_target_asset "$(installer_repo_join_var DIR_HOOKS_SHARED_TARGET etc/initramfs-tools/scripts/init-bottom/90-installer-health)" "${FILE_INITRAMFS_HEALTH_INIT_BOTTOM}" 0755
  ...
  stage_target_asset "$(installer_repo_join_var DIR_HOOKS_SHARED_TARGET usr/local/libexec/secondboot-cleanup)" "${FILE_SECONDBOOT_HELPER}" 0755
  stage_target_asset "$(installer_repo_join_var DIR_HOOKS_SHARED_TARGET etc/systemd/system/secondboot.service)" "${FILE_SECONDBOOT_SERVICE}" 0644
